...
В случаи, если репозиторий имеет устаревший вид, мы можем обновить его с помощью команды git pull, данная команда позволяет выкачивать все изменения и сливать их.
